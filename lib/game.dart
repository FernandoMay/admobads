import 'package:admobads/ad.dart';
import 'package:admobads/drawing.dart';
import 'package:admobads/painter.dart';
import 'package:admobads/quiz.dart';
...
class _GameRouteState extends State<GameRoute> implements QuizEventListener {
  ...
  void initState() {
    ...
    BannerAd(
      adUnitId: AdDelegate.bannerAdUnitId,
  ...
  void _loadInterstitialAd() {
    InterstitialAd.load(
      adUnitId: AdDelegate.interstitialAdUnitId,
      request: const AdRequest(),
  ...
  void _loadRewardedAd() {
    RewardedAd.load(
      adUnitId: AdDelegate.rewardedAdUnitId,
      request: const AdRequest(),
